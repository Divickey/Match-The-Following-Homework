...
finals = pygame.image.load("finals.jpg")
spacemarine = pygame.image.load("spacemarine2.jpg")
wukong = pygame.image.load("wukong.jpeg")

screen.blit(subway,(150,100))
screen.blit(ludo,(150,200))
screen.blit(temple,(150,300))
screen.blit(candy,(150,400))
screen.blit(finals,(150,500))
screen.blit(spacemarine,(150,600))
screen.blit(wukong,(150,700))

font = pygame.font.SysFont("Comic Sans", 36)
text1 = font.render("Wukong", True, (0,0,0))
text2 = font.render("The Finals", True, (0,0,0))
text3 = font.render("Candy Crush", True, (0,0,0))
text4 = font.render("Subway Surfers", True, (0,0,0))
text5 = font.render("Temple Run",True, (0,0,0))
text6 = font.render("Space Marine 2",True, (0,0,0))
text7 = font.render("Ludo", True, (0,0,0))
...
screen.blit(text6,(350, 600))
screen.blit(text7,(350, 700))
pygame.display.update()
